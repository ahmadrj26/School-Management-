...
<!-- Main Content -->
    <div class="display_class">
        <div class="container">
            ...
            <h2 style="text-align: center; font-weight: 1000; color: #333;">Pupils in Reception Year</h2>
            <div class="search-bar">
                <form method="get" action="reception_year.php">
...
<!-- Pagination -->
                <div class="pagination">
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        <a href="reception_year.php?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>" class="<?php if ($i == $page) echo 'active'; ?>"><?php echo $i; ?></a>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
