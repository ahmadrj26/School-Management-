...
if (isset($_SESSION['register_success'])) {
    $login_message = $_SESSION['register_success'];
...
.account_form, .account_logged_in {
...
.account_form h1, .account_logged_in h1 {
    font-size: 24px;
    margin-bottom: 20px;
    color: #303030;
    text-align: center;
...
.account_logged_in .button-group {
    display: flex;
    justify-content: center;
}
...
<!--login form-->
    <div class="account_page">
        <div class="account_form" id="account_form">
            <h1>Login</h1>
            <?php if ($login_message): ?>
                <div id="alert-message" style="color: green; margin-bottom: 20px;"><?php echo $login_message; ?></div>
            <?php else: ?>
...
<script>
        ...
        if (isset($_SESSION['login_error'])) {
            echo 'displayAlert("' . $_SESSION['login_error'] . '");';
